...
val Blockchain.description: String
    get() = when (type) {
        ...
        BlockchainType.Fraxtal -> "L2 chain"
...
val BlockchainType.imageUrl: String
    get() = if (this == BlockchainType.Fraxtal) {
        "https://static.frax.com/images/chains/fraxtal.png"
    } else {
...
val BlockchainType.tokenIconPlaceholder: Int
    get() = when (this) {
        ...
        BlockchainType.Fraxtal -> R.drawable.fraxtal
...
val BlockchainType.brandColor: Color?
    get() = when (this) {
        ...
        BlockchainType.Fraxtal -> Color(0xFF000000)
